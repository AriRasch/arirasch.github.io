...
1.  R. Schulze, S. Gorlatch, **A. Rasch** \\
    ...
    *ACM SIGPLAN International Conference on Compiler Construction (CC 2025)*\\
    <a href="../assets/files/publications/cc25/paper_1.pdf"><i class="fas fa-file-pdf" style="color: red; font-size: 2em; padding-top: .4em"></i></a> [Paper](../assets/files/publications/cc25/paper_1.pdf)
